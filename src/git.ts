...
import { evidenceSchema, type Evidence, type Release } from './model.js';
...
export function collect(root: string, from: string | null, to: string): { evidence: Evidence; patch: string } {
...
export function checkPrevious(root: string, previous: Release, evidence: Evidence): void {
