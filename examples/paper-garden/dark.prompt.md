...
User-visible change: A new craft lesson shows how to assemble a small paper garden.
Subject: A preview of a paper garden craft lesson
Focal detail: One handmade paper flower standing in a folded paper pot
...
Archetype: editorial-scene
Target canvas: 1280 × 800 pixels; landscape 1280:800. Produce a single image, not a dark/light collage.
Compose one coherent scene around the actual announced experience. Establish a clear foreground subject and quiet supporting background. Keep it legible as a small release card.
Specific scene layout: One coherent tabletop still life, softly lit from upper left, with a single coral five-petal paper flower and warm yellow circular center on one green paper stem with exactly two folded green leaves. The stem stands inside one small warm terracotta-colored folded paper pot resting on the tabletop. Flower and pot centered as one vertical subject, occupying about 64 percent of canvas height. Two spare flat paper pieces, one coral and one green, rest quietly on the tabletop to the right of the pot. Tactile paper folds and cut edges, natural paper colors. A seamless quiet backdrop changes presentation theme only. No interface frame.
Elements:
- One five-petal coral paper flower with yellow center
- One green stem and two folded leaves
- One terracotta-colored folded paper pot
- Two spare paper pieces on the tabletop

## Visual treatment
Use natural color, rich materials, or playful elements only when they belong to the feature. Reserve this treatment for a content or seasonal experience; it is not the default for routine fixes or settings.
...
Specific invariants:
- Five petals, two leaves, single stem and pot assembly
- Natural coral, yellow, green and terracotta paper colors
- Two loose pieces, camera, object placement and contact shadows
...
## Exclusions
- Extra flowers, tools, hands or tutorial step panels
- Living plants or unrelated seasonal scenery
- Text, logos or product promises
No watermark, stock-photo caption, extra claims, or decorative objects unrelated to the change.

## Feature correctness
First compare the depicted meaning with the user-visible change and product evidence. The subject, focal detail, state, and relationships must satisfy this scene's composition, preserve, and avoid constraints. Apply only checks relevant to this feature. Check that the depicted subject and experience match the announced content. Keep essential object relationships coherent and avoid added features, factual promises, or unrelated scenery.
