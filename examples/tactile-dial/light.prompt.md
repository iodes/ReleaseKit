...
User-visible change: The desktop timer gains a ribbed adjustment dial that is easier to locate by touch.
Subject: The ribbed adjustment dial of a fictional desktop timer
Focal detail: Shallow vertical grip ribs around one physical dial
...
Show a close view of the relevant product part; choose a restrained three-quarter or orthographic angle. Preserve feature-defining silhouettes and enough context to recognize the object.
Specific scene layout: Close three-quarter studio view from slightly above of a fictional compact timer: a low warm-gray matte rounded rectangular base, with exactly one broad cylindrical dial attached vertically to its top. Base occupies about 52 percent of canvas width, centered slightly below mid-height. Dial diameter about half the base width; low cylindrical height; evenly spaced shallow vertical ribs around its side. A single small blue index notch on the top of the dial at the front. The entire base and dial remain visible. No display, cable, buttons, markings or extra parts. Soft studio light makes the ribs readable.
Elements:
- One warm-gray matte rounded rectangular timer base
- One attached low cylindrical dial with shallow vertical ribs
- One small blue index notch on the dial top

## Visual treatment
Soft studio lighting and clean matte or authentic product materials. Use quiet depth, contact shadows, and sparse highlights; accent the changed part only. Do not invent an unrelated physical product.
...
Specific invariants:
- Base and dial assembly, contact and relative scale
- Ribbed circumference and single blue index notch
- Camera and natural warm-gray material in both themes
...
## Exclusions
- Floating or detached dial
- Additional buttons, display, cables or measurements
- Glossy chrome or invented physical components
No watermark, stock-photo caption, extra claims, or decorative objects unrelated to the change.

## Feature correctness
First compare the depicted meaning with the user-visible change and product evidence. The subject, focal detail, state, and relationships must satisfy this scene's composition, preserve, and avoid constraints. Apply only checks relevant to this feature. Check the feature-defining shape, scale, assembly, contact points, and material against product references. A highlight must not invent a component or change how the object works.
